...
<div class="container py-5">
    {{-- Ép khung nhỏ lại bằng col-lg-10 và căn giữa màn hình --}}
    <div class="row justify-content-center">
        <div class="col-lg-12">

            {{-- HEADER VÀ NÚT BẤM CÙNG NẰM TRÊN 1 HÀNG --}}
            <div class="d-flex justify-content-between align-items-center mb-4">

                {{-- Phần Tiêu đề bên trái --}}
                <div>
                    <h2 class="fw-bold text-primary mb-1"><i></i> Coordinator Dashboard</h2>
                    <p class="text-muted mb-0">Overview of ideas in your Department.</p>
                </div>

                {{-- Phần Nút bấm bên phải (Tự động dạt sát góc phải của khung) --}}
            ...
            {{-- BẢNG DANH SÁCH IDEAS --}}
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="card-header bg-white py-3 px-4">
                    <h5 class="mb-0 fw-bold"><i ></i> Latest Submissions</h5>
                </div>
